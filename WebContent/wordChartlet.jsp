...
<div class="block-inline">
	...
	<button class="btn bg-sub margin-left" onclick="createWordChartlet()">创建套图</button>
</div>
<div id="wordChartletList">
	<c:forEach items="${chartlets }" var="o">
		<c:if test="${o.type=='0'}">
			<div class=" border margin-top bg-yellow-light" id="chartletPictureDiv${o.chartletId }">
