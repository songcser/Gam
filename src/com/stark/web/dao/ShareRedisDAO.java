...
public class ShareRedisDAO implements IRedisDAO{

    private static final Logger log = Logger.getLogger(ShareRedisDAO.class);
...
//        boolean broken = false;
//        try {
//            result = shardedJedis.expireAt(key, seconds);
//
//        } catch (Exception e) {
//            log.error(e.getMessage(), e);
//            broken = true;
